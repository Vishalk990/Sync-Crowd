...
import { frequencies, tiers, CheckIcon } from './pricingContent';
            ...
            {tiers.map((tier) => (
              ...
              >
                ...
                <p className="mt-6 flex items-baseline gap-x-1">
                  <span
                    className={`text-4xl font-bold tracking-tight ${tier.featured ? 'text-white dark:text-black' : 'text-black dark:text-white'
                  ...
                  <span
                    className={`${tier.featured ? 'text-white dark:text-black' : 'text-black dark:text-white'
                      }`}
                  >
                ...
                <div className={`flex gap-2 m-4 p-3 rounded-xl font-semibold ${tier.featured ? 'text-white dark:text-black' : ''
                  } ${tier.highlighted
                    ? 'text-slate-500'
                    : 'text-gray-500'
                  }`}>
                  <CircleDollarSign />{tier.credits}
                </div>
              </div>
            ))}
          </div>
